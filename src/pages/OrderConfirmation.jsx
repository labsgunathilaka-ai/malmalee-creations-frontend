...
const Checkout = ({ onNavigate = () => {} }) => {
  ...
  // Sample purchased items for the confirmation table
  const orderItems = [
    {
      id: 1,
  ...
  // ORDER CONFIRMATION VIEW (MATCHING YOUR IMAGE)
  if (isSubmitted) {
          ...
          <div className="flex items-start gap-4 border-b pb-6">
            ...
            <div>
              ...
              <p className="text-xs md:text-sm text-gray-700 mt-1 font-sans">
                Your order of <span className="font-bold">LKR 4,160.00</span> for 4 items has been received to be delivered by <span className="font-bold">{paymentMethod === 'cod' ? 'Cash on Delivery (COD)' : 'Online Payment'}</span> in 2-3 business days.
              </p>
            </div>
          </div>

          {/* Purchased Items Table Component */}
